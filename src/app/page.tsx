...
const toneOptions = [
  { value: "Formal", icon: "🎩", description: "Professional and structured" },
  { value: "Casual", icon: "😎", description: "Relaxed and friendly" },
  { value: "Technical", icon: "🔧", description: "Precise and detailed" },
  { value: "Persuasive", icon: "🎯", description: "Compelling and convincing" },
];
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-end">
                  <div className="flex-1">
                    ...
                    <Select value={tone} onValueChange={setTone}>
                      <SelectTrigger className="bg-white/80 border-2 border-gray-200 focus:border-blue-400">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
